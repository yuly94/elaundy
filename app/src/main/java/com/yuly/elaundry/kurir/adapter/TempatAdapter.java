package com.yuly.kurir.adapter;
...
import com.yuly.kurir.widgets.BubbleTextGetter;
 ...
 */
public class TempatAdapter extends RecyclerView.Adapter<TempatAdapter.GmailVH>  implements BubbleTextGetter {
   ...
   // List<PesananModels> superHeroes;
    ...
    public GmailVH onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_row_place, viewGroup, false);
